  ...
  return (
    <div className="p-8 space-y-6">
      ...
      {realSensorData && isConnected && (
        <div className="bg-green-50 border border-green-200 rounded-lg p-4">
          <p className="text-green-800 text-sm">
            ✅ <strong>Sensor Labtek 5 - A connected!</strong> Real-time: {realSensorData.occupied} occupied, {realSensorData.available} available ({realSensorData.occupancy}%)
          </p>
        </div>
      )}
      ...
      <Card className="bg-white shadow-lg border-0 p-6">
        <h3 className="text-lg font-bold text-gray-800 mb-4">Real-Time Sensor Data (Labtek 5 - A)</h3>
        {realSensorData && (
